...
const About = () => {
  return (
    <div className="w-full min-h-screen bg-black relative" id='About'>
    ...
    <div className="z-10 backdrop-blur-md min-h-screen flex justify-center items-center shadow-bg-inner border-t-4 border-black">

    <div className='flex md:flex-row flex-col items-center'>
    <div className='flex flex-col max-h-[450px] md:w-[350px] w-[80vw] pt-8'>
